...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { columns: @plane.columns, is_available: @plane.is_available, name: @plane.name, rows: @plane.rows } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { columns: @plane.columns, is_available: @plane.is_available, name: @plane.name, rows: @plane.rows } }
